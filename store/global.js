...
export const Server = {
    endpoint: process.env.NEXT_APP_ENDPOINT,
    project: process.env.NEXT_APP_PROJECT,
    collectionID: process.env.NEXT_APP_COLLECTION_ID,
    databaseID: process.env.NEXT_APP_DATABASE_ID,
};
