            ...
            <div style={{
                ...
                <div className="flex flex-wrap" style={{
                    ...
                    <a className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Plan and Manage</h5>
                    ...
                    <a className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Reduce Plate Waste</h5>
                        <p className="font-normal text-gray-700 dark:text-gray-400">
                            <ul className="list-disc">
                    ...
                    <a className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Donate Surplus Food</h5>
                        <p className="font-normal text-gray-700 dark:text-gray-400">
                            <ul className="list-disc">
                    ...
                    <a className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Composting</h5>
                        <p className="font-normal text-gray-700 dark:text-gray-400">
                            <ul className="list-disc">
